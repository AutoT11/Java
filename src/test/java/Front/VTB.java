package Front; //вынести все элементы xpath в отдельный класс папку paje (для каждой страницы свов класс) и создать в папку мейн+тесты отдельно, классы со старницами отдельно
